...
/**
 * The interface <code>writeableBus</code> represents an bus where we can write
 * bytes.
 * To do this the methods <code>write</code> is provided.
 * For convenience the 16 bits of the address are stored in 32 bits (int type)
 *
 * @author Ice
 * @version 1.00 16/08/1999
 */
public interface writeableBus {
  /**
