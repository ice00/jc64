  ...
  public String dcom(int iType, int aType, long addr, long value) {
    ...
    switch (aType) {
      ...
      case A_IDY:    
        ...
        if ((int)addr<=0xFF && !option.commentVic20ZeroPage) return "";
        if ((int)addr>=0x100 && (int)addr<=0x1FF && !option.commentVic20StackArea) return "";
        if ((int)addr>=0x200 && (int)addr<=0x2FF && !option.commentVic20_200Area) return "";
        if ((int)addr>=0x300 && (int)addr<=0x3FF && !option.commentVic20_300Area) return "";
        if ((int)addr>=0x400 && (int)addr<=0x7FF && !option.commentVic20_400Area) return "";
        if ((int)addr>=0x1000 && (int)addr<=0x1DFF && !option.commentVic20UserBasic) return "";
        if ((int)addr>=0x1E00 && (int)addr<=0x1FFF && !option.commentVic20Screen) return "";
        if ((int)addr>=0x2000 && (int)addr<=0x3FFF && !option.commentVic20_8kExp1) return "";
        if ((int)addr>=0x4000 && (int)addr<=0x5FFF && !option.commentVic20_8kExp2) return "";
        if ((int)addr>=0x6000 && (int)addr<=0x7FFF && !option.commentVic20_8kExp2) return "";
        if ((int)addr>=0x8000 && (int)addr<=0x8FFF && !option.commentVic20Character) return "";
        if ((int)addr>=0x9000 && (int)addr<=0x900F && !option.commentVic20Vic) return "";
        if ((int)addr>=0x9010 && (int)addr<=0x901F && !option.commentVic20Via1) return "";
        if ((int)addr>=0x9030 && (int)addr<=0x903F && !option.commentVic20Via2) return ""; 
        if ((int)addr>=0x9400 && (int)addr<=0x97FF && !option.commentVic20Color) return ""; 
        if ((int)addr>=0x9800 && (int)addr<=0x9BFF && !option.commentVic20Block2) return "";
        if ((int)addr>=0x9C00 && (int)addr<=0x9FFF && !option.commentVic20Block3) return "";
        if ((int)addr>=0xA000 && (int)addr<=0xBFFF && !option.commentVic20Block4) return "";
        if ((int)addr>=0xC000 && (int)addr<=0xDFFF && !option.commentVic20BasicRom) return "";
        if ((int)addr>=0xE000 && (int)addr<=0xFFFF && !option.commentVic20KernalRom) return "";          
        switch (language) {
          case LANG_ITALIAN:
            switch ((int)addr) {
